  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-secondary-50 via-white to-primary-50'>
          ...
          <div className='flex items-center justify-between'>
            ...
            <div className='flex items-center gap-4'>
              ...
              <div className='relative group'>
                ...
                {/* Dropdown Menu */}
                <div className='absolute right-0 mt-2 w-48 glass rounded-xl shadow-xl border border-white/20 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 animate-fade-in'>
                  <div className='p-2'>
                    <a
      ...
      <main className='mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8'>
        <div className='glass rounded-4xl p-6 min-h-[calc(100vh-200px)]'>{children}</div>
      </main>
    </div>
  )
}
