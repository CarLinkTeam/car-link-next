      ...
      >
        ...
        <div className="p-6">
          ...
          <div className="mb-4 text-center">
            ...
            <div className="btn-gradient text-white px-6 py-3 rounded-2xl text-sm font-bold transition-all duration-300 hover:scale-105 hover:shadow-lg transform-gpu">
              Ver detalles
            </div>
          </div>
          {/* Owner info */}
